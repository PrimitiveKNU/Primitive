...
export const TestPopup = () => {
  ...
  return (
    <div className="p-8 space-y-4 max-w-2xl mx-auto min-h-screen bg-background">
      <h1 className="text-3xl font-bold mb-8 text-foreground">Popup Component Tests</h1>

      {/* Test 1: Basic Single Button Popup (matching the screenshot) */}
      <div className="border-t border-border pt-4">
        <h2 className="text-xl font-bold mb-2 text-foreground">Test 1: Basic Achievement Popup</h2>
        <p className="text-muted-foreground mb-4">Matches the screenshot with crown emoji</p>
        <button
          onClick={popup1.open}
      ...
      <div className="border-t border-border pt-4">
        <h2 className="text-xl font-bold mb-2 text-foreground">Test 2: Two-Button Confirmation</h2>
        <p className="text-muted-foreground mb-4">Delete confirmation with secondary and danger buttons</p>
        <button
          onClick={popup2.open}
          className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-600 transition"
        >
      ...
      <div className="border-t border-border pt-4">
        <h2 className="text-xl font-bold mb-2 text-foreground">Test 3: Success Popup with Custom Color</h2>
        <p className="text-muted-foreground mb-4">Success message with accent color button</p>
        <button
          onClick={popup3.open}
          className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-600 transition"
        >
      ...
      <div className="border-t border-border pt-4">
        <h2 className="text-xl font-bold mb-2 text-foreground">Test 4: Lucide Icon with Size Variant</h2>
        <p className="text-muted-foreground mb-4">Using Lucide React Crown icon with large size</p>
        <button
          onClick={popup4.open}
          className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-600 transition"
        >
