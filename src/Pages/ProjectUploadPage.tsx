...
const ReactQuillWithRef = forwardRef<ReactQuill, ReactQuillWithRefProps>(
  (props, ref) => {
      ...
      <div className='max-w-5xl w-full mt-16 mb-20 mx-auto p-5 md:p-5 project-upload'>
        ...
        <div className='flex flex-col md:flex-row gap-2 items-stretch md:items-center'>
          <div className='flex flex-col col1 w-full md:w-1/2'>
              ...
              <div className='w-full inline-flex flex-wrap gap-3 items-center p-1'>
                ...
                {participants.map((participant, index) => (
                  <span
                    ...
                    onClick={() => {
                      setParticipants(
                        participants.filter((_, idx) => index !== idx),
                      );
                    }}
              ...
              <div className='w-full flex flex-wrap gap-3 items-center p-1'>
                ...
                {techStacks.map((tech, index) => (
                  <span
                    ...
                    onClick={() => {
                      setTechStacks(
                        techStacks.filter((_, idx) => index !== idx),
                      );
                    }}
            ...
            <div className='w-full flex flex-wrap gap-3 items-center p-1'>
              <h3 className='px-2 py-1.5 bg-teal-950 text-white rounded-md'>
                프로젝트 미공개
              </h3>
        ...
        <div className='flex gap-1 justify-between'>
          <div className='w-1/2 flex flex-wrap gap-3 items-center p-1 '>
            <h3 className='px-2 py-1.5 bg-black text-white rounded-md'>
              Github Repository
            </h3>
            <input
